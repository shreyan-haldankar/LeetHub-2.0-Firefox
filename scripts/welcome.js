...
const createRepo = (token, name) => {
  ...
  let data = {
    ...
    auto_init: true,
    description:
      'Collection of LeetCode questions to ace the coding interview! - Created using [LeetHub v2 for Firefox](https://github.com/shreyan-haldankar/LeetHub-2.0-Firefox)',
  };
